...
/*   Updated: 2020/05/13 10:49:46 by jirwin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
unsigned short int		*add_nb(unsigned short int *a, unsigned short int *b,\
																	int *point);
void					copy_number_0(unsigned short *dest,\
														unsigned short *src);
char					*nbtoa1(unsigned short *c, int point, int afterpoint,\
													int sign, char *specdot);
char					*round_nb(unsigned short *n, int point, int afterpoint,\
													char sign, char *specdot);
